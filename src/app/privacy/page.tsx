        ...
        <div className={pageStyles.wrapper}>
          <div className={pageStyles.contentContainer}>
            ...
            <div className={pageStyles.fadeIn}>
              ...
              <h4>Cookies</h4>
              <p>
                This website sometimes uses cookies, small text files that are stored on your computer and managed by
                your browser. Cookies are used to make the website more user-friendly, effective and secure.
              </p>
              <p>
              ...
              <h4>Vercel</h4>
              <p>
                This website uses the <Link href='https://vercel.com/'>Vercel</Link> service. The provider is Vercel
                Inc, 340 S Lemon Ave #4133, Walnut, CA 91789, USA. Vercel is a cloud platform through which we provide
                our website. provide our website. This means that visits to our website are processed or routed through
                Vercel&apos;s servers. is routed through. The data associated with your visit to our website is also
                transmitted to Vercel transmitted. This is necessary so that your browser request can be processed
                successfully. This data includes:
              </p>
              <ul>
                <li>the browser type/version</li>
                <li>the operating system used</li>
              ...
              <p>
                The data processing is carried out on the basis of Art. 6 para. 1 lit. f GDPR, as the data transmission
                is necessary in order to be able to use the website.
              </p>
            </div>
          </div>
        </div>
